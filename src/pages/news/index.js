...
import Items from '../../Components/newsCard';
import SubNavbar from '../../Components/subNavbar';
import '../../styles/news/style.scss';
				...
				<div className="col-md">
					<div className="container ">
						...
						<h1 className="head-text text-center">
							Top News of {props.category} category
						</h1>
						<div className="row">
							{data.map((e, index) => {
								return (
						...
						<div className="d-flex btn-container justify-content-between">
							<button
								disabled={page <= 1}
								onClick={handlprivious}
								type="button"
							...
							<button
								disabled={page > Math.ceil(data.totalResults / 9)}
								onClick={handlnext}
								type="button"
								className="btn btn-primary"
							>
